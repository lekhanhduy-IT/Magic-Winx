...
.jumping-background {
  ...
  pointer-events: none; /* để không cản trở các thao tác bên dưới */
}
...
.hospital-link {
    display: block;
    width: 100px;
    height: 100px; /* bạn muốn height là 100px */
    border: 0px solid;
    left: -21%;
    top: 2%;
    position: relative;
...
<body>
<div class="jumping-background"></div>
<!-- Hospital button -->
<div class="hospital-btn">
    <a href="hospital.php" class="hospital-link"></a>
</div>

<!-- Town button -->
<div class="town-btn">
    <a href="town.php" class="town-link"></a>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const townBtn = document.querySelector('.town-btn');

    if (!currentUser) {
        console.error('Không tìm thấy current user!');
        return;
    }

    setInterval(() => {
        if (isOverlap(currentUser, hospitalBtn)) {
            window.location.href = 'hospital.php';
        } else if (isOverlap(currentUser, townBtn)) {
